cmd_scripts/resource_tool := gcc -Wp,-MD,scripts/.resource_tool.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89   -I./tools/include  -o scripts/resource_tool scripts/resource_tool.c  
