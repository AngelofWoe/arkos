...
#define VCPU_CONTEXT 336 /* offsetof(struct kvm_vcpu, arch.ctxt) */
...
#define VCPU_FPEXC32_EL2 1408 /* offsetof(struct kvm_vcpu, arch.ctxt.sys_regs[FPEXC32_EL2]) */
#define VCPU_ESR_EL2 1440 /* offsetof(struct kvm_vcpu, arch.fault.esr_el2) */
#define VCPU_FAR_EL2 1448 /* offsetof(struct kvm_vcpu, arch.fault.far_el2) */
#define VCPU_HPFAR_EL2 1456 /* offsetof(struct kvm_vcpu, arch.fault.hpfar_el2) */
#define VCPU_HOST_CONTEXT 2504 /* offsetof(struct kvm_vcpu, arch.host_cpu_context) */
