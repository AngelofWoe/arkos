...
/usr/bin/retrorun --triggers -n -s /roms/naomi -d /roms/bios /home/ark/.config/retroarch/cores/"$2"_libretro.so "$3"
...
sudo ln -s /dev/input/event3 /dev/input/by-path/platform-odroidgo2-joypad-event-joystick
sudo chmod 777 /dev/input/by-path/platform-odroidgo2-joypad-event-joystick
/usr/bin/retrorun32 --triggers -n -s /roms/naomi -d /roms/bios /home/ark/.config/retroarch32/cores/"$2"_libretro.so "$3"
sudo kill $(pidof rg351p-js2xbox)
sudo rm /dev/input/by-path/platform-odroidgo2-joypad-event-joystick
fi
